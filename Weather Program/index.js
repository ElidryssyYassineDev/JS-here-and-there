const apiKey = "b3b1699a3dcf997568f327a3295742b8";
...
async function getWeatherData(cityValue){
    try {
        ...
        weatherDataEl.querySelector(".detail").innerHTML = detail.map((detail)=> `<div>${detail}</div>`
        ).join("");
        ...
        weatherDataEl.querySelector(".description").textContent = "SOMETHING WENT WRONG! TRY AGAIN LATER";
